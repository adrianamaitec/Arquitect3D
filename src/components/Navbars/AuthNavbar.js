...
export default function Navbar(props) {
  ...
  return (
    <>
      <nav className="top-0 absolute z-50 w-full flex flex-wrap items-center justify-between px-2 py-3 navbar-expand-lg bg-current">
            ...
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              ...
              <li className="flex items-center">
                <button
                  ...
                  type="button"
                >
                  <i className="fas fa-arrow-alt-circle-down"></i> Empezar
                </button>
              </li>
            </ul>
          </div>
